...
CORE_COLUMNS = [
    ...
    'spot_price', 'h2_kg', 'time', 'hour', '*_duty_kw', '*_q_transferred_kw', '*_heat_flow_kw',
    'ATR_*', 'Biogas_*'
]
...
COLUMN_REQUIREMENTS: Dict[str, List[str]] = {
    ...
    'temporal_sums': CORE_COLUMNS + ['*_outlet_mass_flow_kg_h'], # Updated to use PSA outputs
    ...
    'process_train_profile': [
        ...
        '*_outlet_temp*', 
        '*_outlet_pressure*', 
        '*_outlet_total_mass_flow*',  # Priority 1: Total Mass (Post-Merge)
        '*_outlet_mass_flow*',        # Priority 2: Bulk Mass
        '*_outlet_entrained_mass*',   # Priority 2: Entrained Mass
        '*_outlet_H2O_molf*',         # Priority 1: H2O Molar Fraction
        '*_outlet_H2O_ppm*'           # Priority 2: H2O PPM
    ],
...
class GraphCatalog:
    ...
    def _load_default_registry(self) -> None:
        ...
        self.register(GraphMetadata(
            ...
            library=GraphLibrary.PLOTLY,
            # Requires storage columns + production columns + demand columns
            data_required=[
                'storage_soc', 'storage_action_factor', 
                'H2_pem*', 'H2_soec*', 'H2_atr*', 
                '*demand*'  # Wildcard to catch truck_demand_kg_h etc.
            ],
            priority=GraphPriority.HIGH,
            category='storage',
            enabled=True
        ...
        self.register(GraphMetadata(
            ...
            library=GraphLibrary.PLOTLY,
            # Requires power columns to calc energy + PSA H2 mass flow columns
            data_required=['P_offer', 'P_sold', 'P_pem', 'P_soec', '*_outlet_mass_flow_kg_h'],
            priority=GraphPriority.MEDIUM,
            category='economics',
            enabled=True
        ))
        ...
        self.register(GraphMetadata(
            ...
            title='RFNBO Compliance & Production (Interactive)',
            description='RFNBO vs Non-RFNBO H2 production with price threshold overlay',
            function=pg.plot_rfnbo_compliance,
            library=GraphLibrary.PLOTLY,
            # Use cumulative columns directly
        ...
        self.register(GraphMetadata(
            graph_id='soec_module_degradation_plotly',
            title='SOEC Module Degradation (Tracking)',
            description='Operating hours and SEC per physical module',
            function=pg.plot_soec_module_degradation,
            library=GraphLibrary.PLOTLY,
        ...
        self.register(GraphMetadata(
            ...
            title='5. Plant Balance Schematic',
