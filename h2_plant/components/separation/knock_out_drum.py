...
class KnockOutDrum(Component):
    ...
    def __init__(
        self,
        component_id: str = "knock_out_drum",
    ...
    def get_state(self) -> Dict[str, Any]:
        ...
        state.update({
            ...
            'outlet_total_mass_flow_kg_h': self._gas_outlet_stream.mass_flow_kg_h if self._gas_outlet_stream else 0.0,
            'outlet_gas_mass_flow_kg_h': self._gas_outlet_stream.mass_flow_kg_h if self._gas_outlet_stream else 0.0,
            'outlet_entrained_mass_kg_h': 0.0,

            # Explicit Phase Mass Flows to Avoid User Confusion
            'gas_outlet_mass_flow_kg_h': self._gas_outlet_stream.mass_flow_kg_h if self._gas_outlet_stream else 0.0,
            'liquid_drain_mass_flow_kg_h': self._liquid_drain_stream.mass_flow_kg_h if self._liquid_drain_stream else 0.0
        })
        return state
